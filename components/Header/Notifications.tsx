...
export const Notifications: React.FC = () => {
  return (
    <Popover className="relative flex items-center justify-center">
      ...
      >
        <Popover.Panel className="absolute top-full right-0 z-10 w-96 translate-y-[20%] transform">
          ...
          <ul className="flex w-full flex-col border border-white/25 bg-black/75 before:absolute before:inset-x-0 before:top-0 before:rounded before:border-t-2 before:border-white/75">
            <li>
              <Link href="#">
                <a className="flex gap-5 bg-black/75 p-4 transition-colors hover:bg-black">
                  ...
                  <div>
                    <div className="text-[#CCCCCC] transition-colors hover:text-white">
